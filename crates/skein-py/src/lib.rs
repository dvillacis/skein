...
use skein_core::{
    ...
    groups::Groups,
    penalty::{
        ElasticNet, GroupElasticNet, GroupLasso, GroupLassoFactory, GroupMcpFactory, GroupPenalty,
        LassoFactory, Mcp, McpFactory, Scad, ScadFactory, SparseGroupLasso,
    },
    solver::{
        cd_solve, glasso_solve, joint_glasso_solve, prox_newton_block_solve_path,
        prox_newton_solve_path, solve_block_path, solve_block_path_lla, solve_path, solve_path_lla,
        ...
        GlassoConfig, JointGlassoConfig, PathConfig, Screening,
    },
    standardize::{
...
#[allow(clippy::too_many_arguments)]
fn solve_logistic_elastic_net_path<'py>(
    py: Python<'py>,
    x: PyReadonlyArray2<f64>,
    y: PyReadonlyArray1<f64>,
    alpha: f64,
...
#[allow(clippy::too_many_arguments)]
fn solve_logistic_elastic_net_path_sparse<'py>(
    py: Python<'py>,
    x_data: PyReadonlyArray1<f64>,
    x_indices: PyReadonlyArray1<i64>,
    x_indptr: PyReadonlyArray1<i64>,
...
// ============================================================
// Graphical lasso (M11): single-population and joint estimation.
// ============================================================
...
#[allow(clippy::too_many_arguments)]
fn solve_joint_glasso_lasso<'py>(
    py: Python<'py>,
...
fn _core(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_function(wrap_pyfunction!(solve_logistic_elastic_net_path, m)?)?;
    ...
    m.add_function(wrap_pyfunction!(solve_logistic_elastic_net_path_sparse, m)?)?;
    ...
    m.add_function(wrap_pyfunction!(solve_glasso_lasso, m)?)?;
    m.add_function(wrap_pyfunction!(solve_glasso_mcp, m)?)?;
    m.add_function(wrap_pyfunction!(solve_glasso_scad, m)?)?;
    m.add_function(wrap_pyfunction!(solve_joint_glasso_lasso, m)?)?;
    m.add_function(wrap_pyfunction!(solve_joint_glasso_mcp, m)?)?;
    Ok(())
}
