"""SCAD on Gaussian LS, *sparse* regime.

  λ_min / λ_max = 5e-2
  γ = 3.7

Sparse counterpart of `scad_ls`. Path stops near support recovery
rather than at the saturated tail. Runner ABI and methodology match
`mcp_ls_sparse`; only PENALTY and GAMMA differ.
"""
